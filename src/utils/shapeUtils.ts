...
export function getShapeIcon(shapeType: string): string {
  const icons = {
    ...
    [ShapeType.DECORATIVE_SHAPE]: '♥',
    // Numbers
    [ShapeType.NUMBER_0]: '0️⃣',
    [ShapeType.NUMBER_1]: '1️⃣',
    [ShapeType.NUMBER_2]: '2️⃣',
    [ShapeType.NUMBER_3]: '3️⃣',
    [ShapeType.NUMBER_4]: '4️⃣',
    [ShapeType.NUMBER_5]: '5️⃣',
    [ShapeType.NUMBER_6]: '6️⃣',
    [ShapeType.NUMBER_7]: '7️⃣',
    [ShapeType.NUMBER_8]: '8️⃣',
    [ShapeType.NUMBER_9]: '9️⃣',
    [ShapeType.NUMBER_10]: '🔟',
    // Letters
    [ShapeType.LETTER_A]: '🅰',
    [ShapeType.LETTER_B]: '🅱',
