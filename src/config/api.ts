...
export const API_ENDPOINTS = {
  ...
  assets: {
    ...
    update: (id: string) => `${prefix}/assets/${id}`,
    delete: (id: string) => `${prefix}/assets/${id}`,
    stats: `${prefix}/assets/stats`,
  },
  audio: {
    base: `${prefix}/audio`,
    list: `${prefix}/audio`,
    upload: `${prefix}/audio/upload`,
    detail: (id: string) => `${prefix}/audio/${id}`,
    update: (id: string) => `${prefix}/audio/${id}`,
    delete: (id: string) => `${prefix}/audio/${id}`,
    favorite: (id: string) => `${prefix}/audio/${id}/favorite`,
  },
  templates: {
  ...
  export: {
    ...
    status: (exportId: string) => `${prefix}/export/status/${exportId}`,
    download: (exportId: string) => `${prefix}/export/download/${exportId}`,
  },
  ai: {
    status: `${prefix}/ai/status`,
    generateImagePrompt: `${prefix}/ai/generate-image-prompt`,
    generateScript: `${prefix}/ai/generate-script`,
    generateVoice: `${prefix}/ai/generate-voice`,
    generateMusic: `${prefix}/ai/generate-music`,
    voices: `${prefix}/ai/voices`,
  },
  fonts: {
    list: `${prefix}/fonts`,
  },
  ...
  userApiKeys: {
    base: `${prefix}/user/api-keys`,
    list: `${prefix}/user/api-keys`,
    save: `${prefix}/user/api-keys`,
    detail: (id: string) => `${prefix}/user/api-keys/${id}`,
    validate: (id: string) => `${prefix}/user/api-keys/${id}/validate`,
    delete: (id: string) => `${prefix}/user/api-keys/${id}`,
  },
  aiUsage: {
    current: `${prefix}/ai-usage/current`,
    history: `${prefix}/ai-usage/history`,
  },
  roles: {
    base: `${prefix}/roles`,
    list: `${prefix}/roles`,
    create: `${prefix}/roles`,
    detail: (roleId: string) => `${prefix}/roles/${roleId}`,
    update: (roleId: string) => `${prefix}/roles/${roleId}`,
    delete: (roleId: string) => `${prefix}/roles/${roleId}`,
    assign: (roleId: string) => `${prefix}/roles/${roleId}/assign`,
  },
  health: {
    check: `${prefix}/health`,
